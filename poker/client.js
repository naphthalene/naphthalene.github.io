...
UsernameInput = React.createClass({
  ...
  onSubmit: function() {
    return sendMessage("Connected: " + this.refs.uname_input.getValue());
  },
  render: function() {
...
PlayerOverview = React.createClass({
  ...
  render: function() {
    ...
    }, React.createElement(ListGroup, null, this.state.players.map(function(name) {
...
TableJoinState = React.createClass({
  render: function() {
...
JoinedState = React.createClass({
  render: function() {
    return React.createElement("div", null, React.createElement(GameNavigation, null), React.createElement(Grid, null, React.createElement(Row, null, React.createElement(Col, {
      ...
      "md": 4.,
      "lg": 4.
    }, React.createElement(PlayerOverview, null)))));
  }
});
...
MainState = React.createClass({
  ...
  render: function() {
    return React.createElement("div", null, React.createElement(GameNavigation, null), React.createElement(Grid, {
      ...
      "mdoffset": 3.,
      "lgoffset": 4.
    }, React.createElement(Row, null, React.createElement(Turn, null), React.createElement("h3", null, "Remaining ", React.createElement(Label, null, "$", this.state.remaining)), React.createElement(MainActions, null))))));
  }
});
...
client = {
  ...
  setState: function(state_name) {
    ...
    return React.render(React.createElement(this.states[state_name], {
      client: client
...
receiverMessage = function(namespace, message) {
  return appendMessage("receiverMessage: " + namespace + ", " + message);
};
